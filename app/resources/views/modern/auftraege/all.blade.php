...
<style>*{box-sizing:border-box}body{margin:0;font:14px Segoe UI,Arial;background:#f4f6f8;color:#1f2937}.page{max-width:1250px;margin:auto;padding:32px}.card{background:#fff;border-radius:12px;box-shadow:0 2px 8px #0001;padding:24px}.toolbar{display:flex;gap:8px;margin:16px 0}.toolbar input{flex:1;max-width:420px;padding:10px;border:1px solid #cbd5e1;border-radius:7px}.button{padding:10px 14px;border:0;border-radius:7px;background:#0369a1;color:#fff;text-decoration:none}table{width:100%;border-collapse:collapse}th,td{padding:10px 8px;border-bottom:1px solid #e5e7eb;text-align:left;vertical-align:top}th{font-size:12px;text-transform:uppercase;color:#64748b}a{color:#0369a1;text-decoration:none}.muted{color:#64748b}</style></head><body>
