...
<p><button class="button" type="submit">Auftrag speichern</button> <a class="button" href="{{ $id ? route('kunden.auftraege.show',[$kunde->intID,$id]) : route('kunden.auftraege.index',$kunde->intID) }}">Abbrechen</a></p></form></div></body></html>
