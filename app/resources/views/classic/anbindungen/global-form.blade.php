...
<div class="line"><span>Kopie der Rechnungsinfo:</span><div class="readonly-filter" tabindex="0" data-filter-field="invoice_info" data-filter-value="{{ old('strKopieRechnungsinfo',$anbindung->strKopieRechnungsinfo ?? '') }}">{{ old('strKopieRechnungsinfo',$anbindung->strKopieRechnungsinfo ?? '') }}</div></div>
