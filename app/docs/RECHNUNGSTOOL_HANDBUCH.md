...
Die Option **Accountings berücksichtigen** ist nun wirksam. Ist sie ausgeschaltet, werden Accountingpositionen wie im alten Rechnungstool übersprungen. Ist sie eingeschaltet, werden Staffeltyp 1 und 2 sowie inzwischen auch Typ 3, 4 und 7 lesend berechnet: Typ 1 nutzt Monatsnutzung und Preisstufe, Typ 2 Freimenge/Basispreis/Einheitspreis, Typ 3 die Dialin-EVN-Zeitbewertung und Typ 4 bzw. 7 die Bandbreitenbewertung nach MAX(In/Out) bzw. SUM(In+Out). Die Vorschau zeigt Nutzung/Menge, ermittelten Basisbetrag, Rabatt, Umsatzsteuer und den Vergleich mit bereits berechneten Beträgen. Domainpreise (Typ 5), Bereichsstaffeln (Typ 6) und Vorberechnung folgen schrittweise. Der Testlauf verändert keine Abrechnungsdaten; insbesondere werden auch keine historischen Dialin-Preiscaches aktualisiert. Abweichungen zum bisherigen Tool müssen vor einer produktiven Freigabe geklärt werden.
