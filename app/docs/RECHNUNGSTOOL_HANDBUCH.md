...
Noch nicht freigegeben sind die tatsächliche Nutzung dieser produktiven Rechnungserzeugung im normalen Bedienablauf, die Ausführung von E-Mail-Versand und Druckübergabe, die Erzeugung von SEPA-Dateien, XRechnung und Mahnwesen.
...
Die PDF-Vorlage wurde außerdem im unteren Rechnungsbereich überarbeitet. Seitenränder und Abstände wurden vereinheitlicht, Tabellenzeilen und Summenblöcke gegen ungünstige Seitenumbrüche abgesichert, der Summenbereich klarer gegliedert und der Firmen-/Bankfuß kompakter ausgerichtet. Zusätzliche bestätigte Rechnungshinweise erscheinen als eigener hervorgehobener Abschnitt vor dem Leistungszeitraum. Die PDF-Vorschau bleibt weiterhin eindeutig als Entwurf gekennzeichnet.
