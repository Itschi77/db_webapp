...
Im Classic-Modus ist der bisher deaktivierte **Start**-Button nun für read-only Testläufe aktiv. Ist eine Auftragsnummer gesetzt, wird nur dieser Auftrag geprüft; ist eine Kundennummer gesetzt, erfolgt ein Kundenlauf; bei Auftrag 0 und Kunde 0 wird der Gesamttestlauf gestartet. Unterhalb des Rechnungstools wird in Classic und Modern außerdem eine Box **Manuell prüfen** angezeigt. Sie enthält die acht nach dem DB-Refresh vom 17.09.2026 noch offenen Prüffälle mit direktem Link zum Auftrag. Aktuell sind dies zwei eingefrorene Aufträge, vier verwaiste Domain-Referenzen und zwei Fälle mit fehlendem Staffel-Accounting. Die Liste dient ausschließlich der manuellen Kontrolle. Es werden weiterhin keinerlei Rechnungs- oder Accountingdaten geschrieben.
