...
Für die abschließende read-only Abnahme wurde in der modernen Fakturierungsansicht zusätzlich ein automatischer **Endtest Rechnungstool** ergänzt. Er sucht im gewählten Zeitraum reale Vertreter für Festpreis, Voraus, Staffel/Accounting, Domain, Mehrpositionen und Rabatt, führt dieselbe Berechnungs-/Konsistenzlogik wie die Einzelvorschau aus und rendert für erfolgreiche Fälle eine temporäre PDF über die produktive Word/LibreOffice-Strecke. Zusätzlich werden `\\janus\Rechnungen`, der read-only MIDAS-Altpfad, der deaktivierte Produktivschreibschalter und der PDF-Renderer geprüft. Der Lauf schreibt weder Rechnungen noch Abrechnungsdaten.
