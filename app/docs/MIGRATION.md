...
Für einen ausgewählten Auftrag zeigt die Vorschau die Auftragspositionen mit Menge, gespeichertem Netto-Endpreis, Rabatt, Umsatzsteuersatz, Fakturierungsdaten, Abrechnungsart und Staffelreferenzen. Zusätzlich wird aus `tblAuftragPosBerechnet` nur lesend angezeigt, wie oft eine Position bereits berechnet wurde und wann zuletzt. Diese Anzeige ist bewusst noch keine fertige Rechnungsberechnung: Intervalllogik, Accountingmengen, Staffelpreise, Domainpreise, Vorberechnung und endgültige Rechnungs-/Steuersummen werden erst in den folgenden Paritätsschritten nachgebaut. Es werden in Phase 1 keine Fakturierungsdaten geschrieben.
