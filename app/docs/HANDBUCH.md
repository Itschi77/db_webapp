...
Die moderne Rechnungstool-Ansicht enthält außerdem **Endtest starten** als gebündelte read-only Abnahme vor der Produktivfreigabe. Der Lauf sucht automatisch repräsentative Echtfälle für Festpreis, Voraus, Staffel/Accounting, Domain, mehrere Dokumentpositionen und Rabatt, rendert erfolgreiche Fälle temporär als PDF und prüft die Rechnungsablage, den MIDAS-Schreibschutz, den deaktivierten Produktivschalter sowie die PDF-Konvertierung. Rot markierte Fälle können sowohl technische Fehler als auch reale blockierende Stammdaten-/Auftragsprobleme anzeigen.
