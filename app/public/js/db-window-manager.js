(() => {
    ...
    const eligiblePath = p => p === '/auftraege' || p.startsWith('/accounting-berichte') || p.startsWith('/anbindungen') || p.startsWith('/netze') || p.startsWith('/ports') || p.startsWith('/dialins') || p.startsWith('/kunden') || p === '/dokumentation' || p === '/handbuch' || p === '/sql-wiki' || p.startsWith('/rechnungen') || p === '/wiedervorlagen' || p === '/fremdaccounting' || p.startsWith('/datev') || p.startsWith('/domainkonditionen') || p.startsWith('/domain-eintraege') || p.startsWith('/domain-eintragen') || p.startsWith('/rechnungslauf') || p.startsWith('/produkte') || p.startsWith('/staffelgruppen') || p.startsWith('/sms-zugaenge') || p.startsWith('/linearstaffeln') || p.startsWith('/bandbreitentarife') || p.startsWith('/bereichsstaffeln') || p.startsWith('/zeittarife') || p.startsWith('/branchen-auswertung') || p.startsWith('/rechnungen-ohne-ust') || p.startsWith('/lastschriften');
