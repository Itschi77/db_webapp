(() => {
    ...
    const eligiblePath = p => p === '/auftraege' || p.startsWith('/kunden') || p === '/dokumentation' || p === '/handbuch' || p.startsWith('/rechnungen') || p === '/wiedervorlagen' || p === '/fremdaccounting' || p.startsWith('/datev');
